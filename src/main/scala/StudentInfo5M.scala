...
object StudentInfo5M extends LineageBaseApp(
                                          threadNum = Some(6), // jteoh retained from original
                                          lineageEnabled = true,
                                          sparkLogsEnabled = false,
                                          sparkEventLogsEnabled = true,
                                          igniteLineageCloseDelay = 60*1000 // in practice, 40s
                                          // seems enough actually. This can also be deleted if
                                          // solely trying to the base app and not actually use
                                          // lineage data.
                                         ){
